                  ...
                  <form class="user" @submit.prevent="SalaryUpdate" >
                    <div class="form-group">
                         ...
                         <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Address" v-model="form.email">
                    ...
                    <div class="form-group">
                         <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <input type="hidden" name="" id="" v-model="form.employee_id">
