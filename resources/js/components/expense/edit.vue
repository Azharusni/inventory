                  ...
                  <form class="user" @submit.prevent="expenseUpdate" enctype="multipart/form-data">
                    <div class="form-group">
                         ...
                         <div class="form-row">
                            ...
                            <div class="col-md-12">
                                <label for="exampleFormControlTextarea1"> <b>Expense Detail</b></label>
                            ...
                            <div class="col-md-12">
                                <label for="exampleFormControlTextarea1"> <b>Expense Amount </b></label>
                                 <input type="text" class="form-control" id="exampleFormControlTextarea1"  v-model="form.amount" placeholder="Input Your Expense Amount">
